# Managerial Effectiveness Index — Technical Document

Document ID: SX-MEI-TD-1.0
...
- Item count: **50**.
- Dimension keys: **SPRI, EXAC, PDCO, TPSC, CFNA, VABI, INSP, SNBU, ORUI, CDQL**.
- Reverse-keyed items: **3**.
