# Self-Limiting Belief Auditor — Technical Document

Document ID: SX-SLBA-TD-1.0
...
- Item count: **20**.
- Dimension keys: **FRAP, EXAG, TBAV, RSOR**.
- Reverse-keyed items: **10**.
