# Communication Signature — Technical Document

Document ID: SX-CS-TD-1.0
...
- Item count: **24**.
- Dimension keys: **COVI, MSPR, AEDR, DICU, COCM, AUCA**.
- Reverse-keyed items: **12**.
