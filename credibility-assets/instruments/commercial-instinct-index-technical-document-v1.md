# Commercial Instinct Index — Technical Document

Document ID: SX-CII-TD-1.0
...
- Item count: **24**.
- Dimension keys: **IUIN, REJR, SOIN, NEGC, PIPD, SOLC**.
