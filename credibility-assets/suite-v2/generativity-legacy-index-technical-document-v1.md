# Generativity & Legacy Index — Technical Document

Document ID: SX-GLI-TD-1.0
...
Generativity & Legacy Index is implemented as a developmental self-report instrument for structured reflection. It is not a clinical, diagnostic, neurological, population-normed or employment-selection instrument. The current Suite v2 governance blocks self-serve access below age 18.

Definition metadata audience: **40+**  
Current operational age posture: **40+ conceptual/catalogue audience; platform self-serve minimum is 18**
