# Emotional Agility Profile — Technical Document

Document ID: SX-EAP-TD-1.0
...
Emotional Agility Profile is implemented as a developmental self-report instrument for structured reflection. It is not a clinical, diagnostic, neurological, population-normed or employment-selection instrument. The current Suite v2 governance blocks self-serve access below age 18.
