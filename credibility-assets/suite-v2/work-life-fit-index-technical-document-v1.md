# Work-Life Fit Index — Technical Document

Document ID: SX-WLFI-TD-1.0
...
Work-Life Fit Index is implemented as a developmental self-report instrument for structured reflection. It is not a clinical, diagnostic, neurological, population-normed or employment-selection instrument. The current Suite v2 governance blocks self-serve access below age 18.

Definition metadata audience: **21+**  
Current operational age posture: **21+ conceptual audience; platform self-serve minimum is 18, catalogue presents 21+**
