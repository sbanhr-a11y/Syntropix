# Identity Compass — Technical Document

Document ID: SX-IC-TD-1.0
...
Identity Compass is implemented as a developmental self-report instrument for structured reflection. It is not a clinical, diagnostic, neurological, population-normed or employment-selection instrument. The current Suite v2 governance blocks self-serve access below age 18.

Definition metadata audience: **14–26**  
Current operational age posture: **18+ self-serve despite definition metadata 14–26**
...
- social comparison regulation

Runtime dimensions:
- `clarity` — 3 items
- `exploration` — 3 items
- `authenticity` — 3 items
- `comparison` — 3 items
