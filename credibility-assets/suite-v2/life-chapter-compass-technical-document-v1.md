# Life Chapter Compass — Technical Document

Document ID: SX-LCC-TD-1.0
...
Life Chapter Compass is implemented as a developmental self-report instrument for structured reflection. It is not a clinical, diagnostic, neurological, population-normed or employment-selection instrument. The current Suite v2 governance blocks self-serve access below age 18.

Definition metadata audience: **35+**  
Current operational age posture: **35+ conceptual/catalogue audience; platform self-serve minimum is 18**
